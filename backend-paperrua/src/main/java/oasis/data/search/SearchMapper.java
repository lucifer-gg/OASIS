...
public interface SearchMapper {
    ...
    /**
     * 通过作者、机构、会议、研究关键词、或时间及其组合检索文章 ID
     *
     * @param authorList
     ...
     * @return
     */
    List<Integer> getDocIdList(@Param("authorList") String authorList, @Param("affiliationList") String affiliationList, @Param("publication") String publication, @Param("keyWordList") String keyWordList, @Param("startTime") String startTime, @Param("endTime") String endTime);
